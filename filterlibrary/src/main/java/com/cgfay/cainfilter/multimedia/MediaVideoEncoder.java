...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    private static final float BPP = 0.6f;
    ...
    public MediaVideoEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener,
                             final int width, final int height, boolean isVideoRecord) {
        super(muxer, listener, true, isVideoRecord);
    ...
    public MediaVideoEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener,
                             final int width, final int height, final boolean enableHD, boolean isVideoRecord) {
        super(muxer, listener, true, isVideoRecord);
        if (DEBUG) Log.i(TAG, "MediaVideoEncoder: ");
        mWidth = width;
        mHeight = height;
