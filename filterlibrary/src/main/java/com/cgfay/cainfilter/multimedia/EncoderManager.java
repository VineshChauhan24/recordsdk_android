...
public class EncoderManager {
    ...
    private EncoderManagerListener listener;

    public EncoderManagerListener getListener() {
        return listener;
    }

    public void setListener(EncoderManagerListener listener) {
    ...
    synchronized public void initRecorder(int width, int height,
        ...
        try {
            ...
            new MediaVideoEncoder(mMuxerManager, listener, mVideoWidth, mVideoHeight,true);
            if (isEnableAudioRecording) {
                new MediaAudioEncoder(mMuxerManager, listener,true);
            }
    ...
    public interface EncoderManagerListener {
