...
import com.cgfay.cainfilter.qukan.GLRGBBressFilter;
import com.cgfay.cainfilter.qukan.GLSepiaFilter;
...
import com.cgfay.cainfilter.qukan.transfer.GLBlackTransferFilter;
import com.cgfay.cainfilter.qukan.transfer.GLLeftTransferFilter;
import com.cgfay.cainfilter.qukan.transfer.GLOutTransferFilter;
import com.cgfay.cainfilter.qukan.transfer.GLRightTransferFilter;
import com.cgfay.cainfilter.qukan.transfer.GLWhiteTransferFilter;
...
public final class FilterManager {
    ...
    public static GLImageFilter getFilter(GLFilterType type) {
        switch (type) {
            ...
            // YUV
            case YUV420:
                return new GLYUV420Filter();
            // YUV
            case YUV:
                return new GLYUVFilter();
            // YUV
            case QKWATERMASK:
                return new GLWATERMASKFilter();

            case Group:
                return new GLGroupFilter();
            case GLSepia:
                return new GLSepiaFilter();
            case RGBBress:
                return new GLRGBBressFilter();
            case QKLeft:
                return new GLLeftTransferFilter();
            case QKRight:
                return new GLRightTransferFilter();
            case QKOut:
                return new GLOutTransferFilter();
            case QKWhite:
                return new GLWhiteTransferFilter();
            case QKBlack:
                return new GLBlackTransferFilter();
