...
public class GLRightTransferFilter  extends GLImageFilter {
    ...
    public GLRightTransferFilter() {
        this(GLLeftTransferFilter_SHADER, GLLeftTransferFilter_SHADER_OES);
    }

    public GLRightTransferFilter(String vertexShader, String fragmentShader) {
