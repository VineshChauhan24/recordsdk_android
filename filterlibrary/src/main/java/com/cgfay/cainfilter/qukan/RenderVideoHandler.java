...
public class RenderVideoHandler extends Handler {
    ...
    private WeakReference<RenderVideo> mWeakRender;


    public RenderVideoHandler(Looper looper, RenderVideo renderThread) {
        super(looper);
        mWeakRender = new WeakReference<RenderVideo>(renderThread);
    }
