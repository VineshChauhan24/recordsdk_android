...
public class GLWhiteTransferFilter  extends GLImageFilter {
    ...
    protected static final String GLLeftTransferFilter_SHADER_OES =
            "precision mediump float;                                   \n" +
                    ...
                    "void main() {                                              \n" +
                    "lowp vec4 otherColor = texture2D(transTexture, textureCoordinate);\n" +
                    "lowp vec4 transColor = vec4(1.0, 1.0, 1.0, 1.0);\n" +
                    "highp float marginLeft = 1.0 - offset;\n" +
                    "gl_FragColor = vec4(transColor.rgb*offset + otherColor.rgb*marginLeft, 1.0);;\n" +
...
//                     "gl_FragColor = vec4(input.rgb*offset + trans.rgb*(1.0 -offset), 1.0);\n" +
    ...
    public GLWhiteTransferFilter() {
        this(GLLeftTransferFilter_SHADER, GLLeftTransferFilter_SHADER_OES);
    }

    public GLWhiteTransferFilter(String vertexShader, String fragmentShader) {
