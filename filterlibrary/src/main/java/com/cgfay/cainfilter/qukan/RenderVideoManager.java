...
public class RenderVideoManager {
    ...
    private static final String TAG = "RenderVideoManager";
...
//        gl420Filter = new GLI420Filter();
        // 渲染滤镜组
        mRealTimeFilter = new GLVideoDefaultFilterGroup();
    ...
    public void onInputSizeChanged(int width, int height) {
        ...
        if(mRealTimeFilter != null &&mTransferFilter != null&&mDisplayFilter != null){
            //44444
            mTextureWidth = width;
    ...
    public void onDisplaySizeChanged(int width, int height) {
        ...
        Log.d(TAG,"onDisplaySizeChanged");
    }
    ...
    public void drawFrame(YuvData data) {
        ...
        if(transfer != null){
            Log.d(TAG,"transfer.getTransFerType():"+transfer.getTransFerType());
            mTransferFilter.changeYuvFilter(transfer.getColorFormat());
...
//            mCurrentTextureId = mTransferFilter.drawFrameBuffer(mCurrentTextureId);
        }
        // 显示输出，需要调整视口大小
        if (mDisplayFilter != null) {
