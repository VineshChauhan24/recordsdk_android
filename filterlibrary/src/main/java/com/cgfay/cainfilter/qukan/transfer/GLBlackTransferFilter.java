...
public class GLBlackTransferFilter extends GLImageFilter {
    ...
    protected static final String GLLeftTransferFilter_SHADER_OES =
            "precision mediump float;                                   \n" +
                    ...
                    "gl_FragColor = vec4(transColor.rgb*marginLeft, 1.0);;\n" +
...
//                     "gl_FragColor = vec4(input.rgb*offset + trans.rgb*(1.0 -offset), 1.0);\n" +
    ...
    public GLBlackTransferFilter() {
        this(GLLeftTransferFilter_SHADER, GLLeftTransferFilter_SHADER_OES);
    }

    public GLBlackTransferFilter(String vertexShader, String fragmentShader) {
