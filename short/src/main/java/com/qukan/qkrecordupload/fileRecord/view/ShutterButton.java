...
public class ShutterButton extends View {
    ...
    // 缩放比例
    private float mZoomValue = 0.85f;// 初始化缩放比例
    ...
    private void init() {
        // 设置外圆背景颜色
        mOuterBackgroundColor = getResources().getColor(R.color.color_quk);
        // 设置内圆背景
        mInnerBackgroundColor = getResources().getColor(R.color.transparent);
        ...
        // 设置进度条颜色
        mOuterStrokeColor = getResources().getColor(R.color.color_quk);
        // 设置进度条宽度
        mStrokeWidth = getResources().getDimension(R.dimen.dp2);
        // 进度条的Paint
...
//                    mButtonHandler.obtainMessage(MSG_ZOOM_ANIM, false), mAnimDuration);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制进度
        canvas.drawArc(mOval, mStartDegree, 360, false, mPaintProgress);
